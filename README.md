...
## 강두홍 | Frontend Developer (Full-Stack Leaning)
> 사람과 시스템 사이의 복잡함을 구조로 정리하는 개발자입니다.  
> 프론트엔드를 중심으로, 백엔드 코드베이스까지 파악하며 전체 흐름을 함께 고려합니다.
 
---
 
### 👋 About Me
- 내부 서비스 및 운영 도구 중심의 프론트엔드 개발
- **프론트에 국한하지 않고, 백엔드 코드베이스를 직접 파악하고 수정·개선**
...
- **Frontend Developer** — Internal Service & Admin Tools (2025.05 ~ Present)
  - Vue.js 기반 방산 결심지원 시스템 개발 및 유지보수
  - 백엔드 소스코드 분석 및 일부 로직 수정 · 리팩토링 경험
  - 사내 프로세스를 효율화하기 위해 과제지원 업무 파악 후 기획, 프론트, 백엔드를 직접 구현
...
- **프론트-백엔드 경계를 넘어, 전체 데이터 흐름을 이해하고 개발**
...
![DataGrip](https://img.shields.io/badge/DataGrip-000000?style=for-the-badge&logo=datagrip&logoColor=fff)
